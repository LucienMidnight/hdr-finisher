...
| Export and file browser | Edge file-chooser handoff, folder-selection UI response, pending-edit synchronization, real SDR PNG export, and validated JPEG Ultra HDR export | `npm run test:export-browser -- --url http://127.0.0.1:8000` |
