...
async function main() {
  ...
  try {
    ...
    const expectedSteps = {
      ...
      "hdr.highlight_rolloff_start_nits": 25,
      ...
      "hdr.lift_range": 0.25,
      "hdr.lift_pivot": 0.25,
      "hdr.gamma_range": 0.25,
      "hdr.gamma_pivot": 0.25,
      "hdr.gain_range": 0.25,
      "hdr.gain_pivot": 0.25,
      "hdr.contrast": 0.001,
      ...
      "sdr.lift_range": 0.25,
      "sdr.lift_pivot": 0.25,
      "sdr.gamma_range": 0.25,
      "sdr.gamma_pivot": 0.25,
      "sdr.gain_range": 0.25,
      "sdr.gain_pivot": 0.25,
      "sdr.contrast": 0.001,
