...
def test_large_frame_analysis_keeps_exact_peak_with_bounded_robust_sample() -> None:
    image = np.full((1500, 1500, 3), 0.18, dtype=np.float32)
    image[1499, 1499] = 4.0

    peak, robust_peak = _luma_peaks(image, maximum_quantile_samples=250_000, rows=64)
